<?php $__env->startPush('alpine-components'); ?>
    <script text="text/javascript">
        window.bitflanQRGeneratorComponent = function() {
            return {
                type: 'url',
                src: 'https://chart.googleapis.com/chart?cht=qr&chs=250x250&chl=Hello',
                href: 'https://chart.googleapis.com/chart?cht=qr&chs=250x250&chl=Hello',
                content: '',
                srv_query: 'Hello',
                ...
                generate() {
                    if(this.type == 'url' || this.type == 'text') {
                        this.srv_query = this.content;
                        this.src = `https://chart.googleapis.com/chart?cht=qr&chs=250x250&chl=${this.content}`;
                        this.href = `https://chart.googleapis.com/chart?cht=qr&chs=250x250&chl=${this.content}`;
                        ...
                        this.href = `https://chart.googleapis.com/chart?cht=qr&chs=250x250&chl=${encodeURIComponent(mstring)}`;
                        this.srv_query = mstring;
...
<div x-data="window.bitflanQRGeneratorComponent()" class="qr-sec-main">
    <div class="qr-sec-left">
        <div class="nav qr-tabs" id="nav-tab" role="tablist">
            <a @click="type = 'url'" x-bind:class="type == 'url' && 'active'" href="javascript:void(0)" aria-selected="true">
                ...
                <?php echo e(trans('webtools/tools/qr-generator.url')); ?>

            </a>
            <a @click="type = 'text'" x-bind:class="type == 'text' && 'active'" href="javascript:void(0)" class=" aria-selected="false">
                ...
                <?php echo e(trans('webtools/tools/qr-generator.text')); ?>

            </a>
            <a @click="type = 'vcard'" x-bind:class="type == 'vcard' && 'active'" href="javascript:void(0)" aria-selected="false">
                ...
                <?php echo e(trans('webtools/tools/qr-generator.vcard')); ?>

            </a>
            <a @click="type = 'email'" x-bind:class="type == 'email' && 'active'" href="javascript:void(0)" class="" aria-selected="false">
                ...
                <?php echo e(trans('webtools/tools/qr-generator.email')); ?>

            </a>
            <a @click="type = 'sms'" x-bind:class="type == 'sms' && 'active'" href="javascript:void(0)" class="" aria-selected="false">
                ...
                <?php echo e(trans('webtools/tools/qr-generator.sms')); ?>
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade" x-bind:class="(type == 'url' || type == 'text') && 'show active'">
                <div class="form-group">
                    <label for="" class="custom-label" x-text="type == 'url' ? '<?php echo e(trans('webtools/tools/qr-generator.url-here-label')); ?>' : '<?php echo e(trans('webtools/tools/qr-generator.content-here-label')); ?>'"><?php echo e(trans('webtools/tools/qr-generator.content-here-label')); ?></label>
                    <textarea x-model="content" type="email" class="rounded custom-textarea" rows="5"></textarea>
                </div>
                <button class="btn custom--btn button__lg" @click="generate()"><?php echo e(trans('webtools/tools/qr-generator.submit')); ?></button>

            </div>
            <div class="tab-pane fade" x-bind:class="(type == 'vcard') && 'show active'">
                <div class="form-group">
                    <label for="" class="custom-label"><?php echo e(trans('webtools/tools/qr-generator.vcard-label')); ?></label>
                </div>
                <form x-on:submit="$event.preventDefault(); generate();">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <input x-model="vcard.fname" type="text" required class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-firstname')); ?>">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <input x-model="vcard.lname" type="text" required class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-lastname')); ?>">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                <input x-model="vcard.mobile" type="text" required class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-mobile')); ?>">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <input x-model="vcard.phone" type="text" required class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-phone')); ?>">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <input x-model="vcard.fax" type="text" required required class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-fax')); ?>">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                <input x-model="vcard.email" type="email" required class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-email')); ?>">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <input x-model="vcard.company" required type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-company')); ?>">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <input x-model="vcard.job" required type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-job')); ?>">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                <input x-model="vcard.street" required type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-street')); ?>">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <input x-model="vcard.city" required type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-city')); ?>">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <input x-model="vcard.zip" required type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-zip')); ?>">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                <input x-model="vcard.state" required type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-state')); ?>">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                <input x-model="vcard.country" required type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-country')); ?>">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                <input x-model="vcard.website" required type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-website')); ?>">
                            </div>
                        </div>
                    </div>
                    <button class="btn custom--btn button__lg"><?php echo e(trans('webtools/tools/qr-generator.submit')); ?></button>
                </form>
            </div>

            <div class="tab-pane fade" x-bind:class="(type == 'email') && 'show active'">
                <div class="form-group">
                    <label for="" class="custom-label"><?php echo e(trans('webtools/tools/qr-generator.email-label')); ?></label>
                </div>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <input x-model="email.email" type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.email-email')); ?>">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <input x-model="email.subject" type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.email-subject')); ?>">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <textarea x-model="email.message" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.email-message')); ?>" rows="5"></textarea>
                        </div>
                    </div>
                </div>
                <button class="btn custom--btn button__lg" @click="generate()"><?php echo e(trans('webtools/tools/qr-generator.submit')); ?></button>
            ...
            <div class="tab-pane fade" x-bind:class="(type == 'sms') && 'show active'">
                <div class="form-group">
                    <label for="" class="custom-label"><?php echo e(trans('webtools/tools/qr-generator.sms-label')); ?></label>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <input x-model="sms.phone" type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.sms-number')); ?>">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <textarea x-model="sms.message" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.sms-message')); ?>" rows="5"></textarea>
                        </div>
                    </div>
                </div>
                <button class="btn custom--btn button__lg" @click="generate()"><?php echo e(trans('webtools/tools/qr-generator.submit')); ?></button>
    ...
    <div class="qr-sec-right">
        <div class="qr-code-title-sec">
            <div class="qr-code-title"><?php echo e(trans('webtools/tools/qr-generator.result-label')); ?></div>
        </div>
        <div class="qr-image"><img x-bind:src="src" src="https://chart.googleapis.com/chart?cht=qr&chs=250x250&chl=Hello" alt=""></div>
        <div class="text-center mt-3">
            <a :href="`<?php echo e(url('download-qr')); ?>/${srv_query}`" class="btn custom--btn button__lg"><?php echo e(trans('webtools/tools/qr-generator.download')); ?></a>
        </div>
    </div>
</div>
<?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/modules/tools/qr-generator/view.blade.php ENDPATH**/ ?>