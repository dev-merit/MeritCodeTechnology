...
<div x-data="window.bitflanDensityComponent()">
    <div class="form-group">
        <textarea x-ref="content" name="" class="rounded custom-textarea" rows="5" placeholder="<?php echo e(trans('webtools/tools/word-density-counter.content')); ?>"></textarea>
    </div>

    <div class="form-group">
        <button x-on:click="generate()" class="btn custom--btn button__lg"><?php echo e(trans('webtools/tools/word-density-counter.submit')); ?></button>
    </div>
...
</div><?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/modules/tools/word-density-counter/view.blade.php ENDPATH**/ ?>