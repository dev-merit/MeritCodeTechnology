    ...
    <div class="single-page-inner">
        ...
        <div class="table-responsive">
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th><?php echo e(trans('webtools/tools/whats-my-browser.your_browser')); ?></th>
                        <th><?php echo e(trans('webtools/tools/whats-my-browser.browser_version')); ?></th>
                        <th><?php echo e(trans('webtools/tools/whats-my-browser.operating_system')); ?></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td><?php echo e($ua['name']); ?></td>
                        <td><span class="badge bg-success"><?php echo e($ua['version']); ?></span></td>
                        <td><?php echo e($ua['platform']); ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/modules/tools/whats-my-browser/view.blade.php ENDPATH**/ ?>