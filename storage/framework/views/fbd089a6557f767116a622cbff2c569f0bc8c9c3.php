...
<div x-data="window.bitflanConvertComponent()">
    <div class="form-group">
        <label class="custom-label"><?php echo e(trans('webtools/tools/image-compressor.image')); ?></label>
        <input type="file" x-ref="upload" class="form-control" accept="image/png,image/jpeg,image/jpg,image/webp,image/svg" />
    </div>
    <div class="form-group">
        <label class="custom-label"><?php echo e(trans('webtools/tools/image-compressor.quality')); ?></label>
    ...
    <div class="form-group">
        <button @click="generate()" class="btn custom--btn button__lg"><?php echo e(trans('webtools/tools/image-compressor.submit')); ?></button>
    </div>
...
<?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/modules/tools/image-compressor/view.blade.php ENDPATH**/ ?>