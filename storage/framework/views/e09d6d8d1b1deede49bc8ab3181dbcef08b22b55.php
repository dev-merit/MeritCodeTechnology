    ...
    <div class="single-page-inner">
        ...
        <form>
            <div class="form-group">
                <label for="weburl" class="custom-label"><?php echo e(trans('webtools/tools/gzip-test.label')); ?></label>
                <input type="text" name="weburl" id="weburl" class="custom-input w-100" value="<?php echo e(request()->input('weburl')); ?>" placeholder="<?php echo e(trans('webtools/tools/gzip-test.placeholder')); ?>" required>
                <?php if(request()->input('submit') && request()->input('weburl') == ''): ?>
                    <div class="alert alert-danger input-alerts"><?php echo e(trans('webtools/tools/gzip-test.must_not_empty')); ?></div>
                <?php endif; ?>
            </div>

            <input type="hidden" name="submit" value="true">
            <button class="btn custom--btn button__lg"><?php echo e(trans('webtools/tools/gzip-test.submit')); ?></button>
            <?php if($error === true): ?>
                <div class="alert alert-danger rounded-pill mt-3 p-l-25 p-r-25 bg-danger border-0"><h5 class="m-0 text-light"><?php echo e(trans('webtools/tools/gzip-test.error')); ?></h5></div>
            <?php endif; ?>
            <?php if(request()->input('submit') && request()->input('weburl') != '' && $error === false): ?>
                <?php if($isGzipEnabled === false): ?>
                    <div class="alert alert-danger rounded-pill mt-3 p-l-25 p-r-25 bg-danger border-0"><h5 class="m-0 text-light"><?php echo e(trans('webtools/tools/gzip-test.not_enabled')); ?></h5></div>
                <?php endif; ?>
                <?php if($isGzipEnabled === true): ?>
                    <div class="alert alert-success rounded-pill mt-3 p-l-25 p-r-25 bg-success border-0"><h5 class="m-0 text-light"><?php echo e(trans('webtools/tools/gzip-test.enabled')); ?></h5></div>
                <?php endif; ?>
            <?php endif; ?>
        </form>
        ...
        <?php if(request()->input('submit') && request()->input('weburl') != ''): ?>
            <div class="table-responsive">
                <table class="table table-striped">
                    <tbody>
                        <?php if($originalSize != null): ?>
                            <tr>
                                <td class="align-middle">
                                    <?php echo e(trans('webtools/tools/gzip-test.label_original_size')); ?>

                                </td>
                                <td class="align-middle"><?php echo e(number_format(($originalSize / 1024), 2)); ?>kb (<?php echo e(number_format($originalSize, 0)); ?>b)</td>
                            </tr>
                        <?php endif; ?>
                        <?php if($gzipSize != null): ?>
                            <tr>
                                <td class="align-middle">
                                    <?php echo e(trans('webtools/tools/gzip-test.label_size')); ?>

                                </td>
                                <td class="align-middle"><?php echo e(number_format(($gzipSize / 1024), 2)); ?>kb  (<?php echo e(number_format($gzipSize, 0)); ?>b)</td>
                            </tr>
                        <?php endif; ?>
                        <?php if($compressionPercentage != null): ?>
                            <tr>
                                <td class="align-middle">
                                    <?php echo e(trans('webtools/tools/gzip-test.label_compression_p')); ?>

                                </td>
                                <td class="align-middle"><?php echo e(number_format($compressionPercentage, 2)); ?>%</td>
                            </tr>
                        <?php endif; ?>
                        <?php if($contentType != null): ?>
                            <tr>
                                <td class="align-middle">
                                    <?php echo e(trans('webtools/tools/gzip-test.label_content_type')); ?>

                                </td>
                                <td class="align-middle"><?php echo e($contentType); ?></td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/modules/tools/gzip-test/view.blade.php ENDPATH**/ ?>