...
<div x-data="window.bitflanHtmlEntityDecodeComponent()">
    <div class="form-group">
        <label class="custom-label"><?php echo e(trans('webtools/tools/html-entity-decode.label')); ?></label>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="form-group">
    ...
    <button x-on:click="convert()" class="btn custom--btn button__lg"><?php echo e(trans('webtools/tools/html-entity-decode.submit')); ?></button>
</div><?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/modules/tools/html-entity-decode/view.blade.php ENDPATH**/ ?>