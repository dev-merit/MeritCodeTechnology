    ...
    <div class="single-page-inner">
        ...
        <form method="POST">
            <div class="form-group">
                <label for="jsonValidator" class="custom-label"><?php echo e(trans('webtools/tools/json-validator.label')); ?></label>
                <textarea type="text" name="jsonValidator" id="jsonValidator" class="custom-textarea" placeholder="<?php echo e(trans('webtools/tools/json-validator.placeholder')); ?>" rows="5" required><?php echo e(request()->input('jsonValidator')); ?></textarea>
                <input type="hidden" name="submit" value="true">
            </div>
            <button class="btn custom--btn button__lg"><?php echo e(trans('webtools/tools/json-validator.submit')); ?></button>
            <?php if(request()->input('submit')): ?>
                <?php if($error == true): ?>
                    <div class="alert alert-danger rounded-pill mt-3 p-l-25 p-r-25 bg-danger border-0"><h5 class="m-0 text-light"><?php echo e(trans('webtools/tools/json-validator.invalid-msg')); ?> <?php echo e($error_msg); ?></h5></div>
                <?php endif; ?>
                <?php if($error_success == true): ?>
                    <div class="alert alert-success rounded-pill mt-3 p-l-25 p-r-25 bg-success border-0"><h5 class="m-0 text-light"><?php echo e(trans('webtools/tools/json-validator.valid-msg')); ?></h5></div>
                <?php endif; ?>
            <?php endif; ?>
        </form>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/modules/tools/json-validator/view.blade.php ENDPATH**/ ?>