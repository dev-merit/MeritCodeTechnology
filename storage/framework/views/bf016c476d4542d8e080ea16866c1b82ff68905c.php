    ...
    <div class="single-page-inner">
        <form>
            <div class="form-group">
                <label for="encodeQuote" class="custom-label"><?php echo e(trans('webtools/tools/quoted-printable-encode.label')); ?></label>
                <textarea type="text" name="encodeQuote" id="encodeQuote" class="custom-textarea" placeholder='<?php echo e(trans('webtools/tools/quoted-printable-encode.placeholder')); ?>' rows="5" required><?php echo e(request()->input('encodeQuote')); ?></textarea>
                <input type="hidden" name="submit" value="true">
            </div>
            <button class="btn custom--btn button__lg"><?php echo e(trans('webtools/tools/quoted-printable-encode.submit')); ?></button>
            <?php if(request()->input('submit') && request()->input('encodeQuote') == ''): ?>
                <div class="alert alert-danger rounded-pill mt-3 p-l-25 p-r-25 bg-danger border-0"><h5 class="m-0 text-light"><?php echo e(trans('webtools/tools/quoted-printable-encode.fieldEmpty')); ?></h5></div>
            <?php endif; ?>
        </form>

        <?php if($encoded_printable): ?>
            <hr class="">

            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        <label class="custom-label"><?php echo e(trans('webtools/tools/quoted-printable-encode.converted-label')); ?></label>
                        <div class="copy-textarea-btn">
                            <textarea type="email" id="encoded-copy" class="custom-textarea" rows="9"><?php echo e($quoted-printable-encode); ?></textarea>
                            <button onclick="window.writeClipboardTextVanilla(this, document.getElementById('encoded-copy').value)" class="btn custom--btn button__md copy-btn btn__dark"><?php echo e(trans('webtools/tools/quoted-printable-encode.btn-copy')); ?></button>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/modules/tools/quoted-printable-encode/view.blade.php ENDPATH**/ ?>