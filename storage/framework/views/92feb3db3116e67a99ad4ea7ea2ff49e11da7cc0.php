...
} elseif ($_instance->childHasBeenRendered('t8MXZJ2')) {
    $componentId = $_instance->getRenderedChildComponentId('t8MXZJ2');
    $componentTag = $_instance->getRenderedChildComponentTagName('t8MXZJ2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('t8MXZJ2');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('t8MXZJ2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('c7fGiSQ')) {
    $componentId = $_instance->getRenderedChildComponentId('c7fGiSQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('c7fGiSQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('c7fGiSQ');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('c7fGiSQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/vendor/filament/filament/src/../resources/views/components/topbar.blade.php ENDPATH**/ ?>