...
<?php endif; ?>
    ...
    <div class="row">
        <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-4">
                <a href="<?php echo e(route('blog-post', $post)); ?>" class="blog-sec-col">
                    <?php if($post->thumbnail): ?>
                        <div class="blog-sec-image" style="background-image: url(<?php echo e(storage_url( $post->thumbnail )); ?>);"></div>
                    <?php endif; ?>
                    <div class="blog-title-sec">
                        <?php $date = \Carbon\Carbon::parse($post->created_at); ?>
                        <div class="date">
                            <?php echo e($date->format('M')); ?><br>
    ...
    <?php if(!count($posts)): ?>
        <p><?php echo e(trans('webtools/blog.no_posts')); ?></p>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/blog.blade.php ENDPATH**/ ?>