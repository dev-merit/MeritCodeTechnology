...
<div x-data="window.bitflanConvertComponent()">
    <div class="form-group">
        <label class="custom-label"><?php echo e(trans('webtools/tools/image-resizer.image')); ?></label>
    ...
    <div class="form-group">
        <label class="custom-label"><?php echo e(trans('webtools/tools/image-resizer.width')); ?></label>
        <input type="number" value="0" x-ref="width" class="custom-input" />
    </div>
    <div class="form-group">
        <label class="custom-label"><?php echo e(trans('webtools/tools/image-resizer.height')); ?></label>
        <input type="number" value="0" x-ref="height" class="custom-input" />
    </div>
    <div class="form-group">
        <button @click="generate()" class="btn custom--btn button__lg"><?php echo e(trans('webtools/tools/image-resizer.submit')); ?></button>
    </div>
...
</div><?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/modules/tools/image-resizer/view.blade.php ENDPATH**/ ?>