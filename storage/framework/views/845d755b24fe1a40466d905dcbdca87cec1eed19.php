...
<div x-data="window.bitflanTextReplacerComponent()">
    <div class="form-group">
        <input type="number" x-model="data" value="0" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/memory-storage-converter.data')); ?>" />
    </div>

    <div class="row">
        <div class="col-6">
            <div class="form-group">
                <label class="custom-label"><?php echo e(trans('webtools/tools/memory-storage-converter.from')); ?></label>
        ...
        <div class="col-6">
            <div class="form-group">
                <label class="custom-label"><?php echo e(trans('webtools/tools/memory-storage-converter.to')); ?></label>
    ...
    <div class="form-group">
        <button x-on:click="generate()" class="btn custom--btn button__lg"><?php echo e(trans('webtools/tools/memory-storage-converter.submit')); ?></button>
    </div>
...
</div><?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/modules/tools/memory-storage-converter/view.blade.php ENDPATH**/ ?>