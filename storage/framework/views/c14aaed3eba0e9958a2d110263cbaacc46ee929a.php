...
} elseif ($_instance->childHasBeenRendered('l1067088305-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1067088305-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1067088305-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1067088305-0');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('l1067088305-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

</div>
<?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/vendor/filament-breezy/components/auth-card.blade.php ENDPATH**/ ?>