    ...
    <div class="single-page-inner">
        ...
        <form>
            <div class="form-group">
                <label for="open_port_checker" class="custom-label"><?php echo e(trans('webtools/tools/open-port-checker.label')); ?></label>
                <input type="text" name="port_link" id="open_port_checker" class="custom-input" placeholder="<?php echo e(trans('webtools/tools/open-port-checker.placeholder')); ?>" value="<?php echo e(request()->input('port_link')); ?>" required>
                <?php if(request()->input('submit') && request()->input('port_link') == ''): ?>
                    <div class="alert alert-danger input-alerts"><?php echo e(trans('webtools/tools/open-port-checker.required-msg')); ?></div>
                <?php endif; ?>
            </div>
            <div class="form-group">
                <label for="port_number" class="custom-label"><?php echo e(trans('webtools/tools/open-port-checker.label-port-num')); ?></label>
                <input type="text" name="port_number" id="port_number" class="custom-input" placeholder="<?php echo e(trans('webtools/tools/open-port-checker.port-placeholder')); ?>" value="<?php echo e(request()->input('port_number')); ?>" required>
                <?php if(request()->input('submit') && request()->input('port_number') == ''): ?>
                    <div class="alert alert-danger input-alerts"><?php echo e(trans('webtools/tools/open-port-checker.required-msg')); ?></div>
                <?php endif; ?>
            </div>
            <input type="hidden" name="submit" value="true">
            <button class="btn custom--btn button__lg"><?php echo e(trans('webtools/tools/open-port-checker.submit')); ?></button>
        </form>
        <?php if(request()->input('port_link') != '' && request()->input('port_number') != ''): ?>
            <?php if(request()->input('submit')): ?>
                <?php if($status === -1): ?>
                    <hr>
                    <div class="alert alert-danger rounded-pill p-l-25 p-r-25 bg-danger border-0"><h5 class="m-0 text-light"><?php echo e(trans('webtools/tools/open-port-checker.port')); ?> <?php echo e(request()->input('port_number')); ?> <?php echo e(trans('webtools/tools/open-port-checker.is')); ?> <span class="badge bg-white text-dark"><?php echo e(trans('webtools/tools/open-port-checker.closed')); ?></span> <?php echo e(trans('webtools/tools/open-port-checker.on')); ?> <?php echo e(request()->input('port_link')); ?>.</h5></div>
                    <?php else: ?>
                    <hr>
                    <div class="alert alert-success rounded-pill p-l-25 p-r-25 bg-success border-0"><h5 class="m-0 text-light"><?php echo e(trans('webtools/tools/open-port-checker.port')); ?> <?php echo e(request()->input('port_number')); ?> <?php echo e(trans('webtools/tools/open-port-checker.is')); ?> <span class="badge bg-white text-dark"><?php echo e(trans('webtools/tools/open-port-checker.open')); ?></span> <?php echo e(trans('webtools/tools/open-port-checker.on')); ?> <?php echo e(request()->input('port_link')); ?>.</h5></div>
                <?php endif; ?>
            <?php endif; ?>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/modules/tools/open-port-checker/view.blade.php ENDPATH**/ ?>