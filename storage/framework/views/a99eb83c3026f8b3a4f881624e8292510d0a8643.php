<form wire:submit.prevent="submit">
    <div class="form-group">
        <label for="url" class="custom-label"><?php echo e(trans('webtools/tools/url-encoder.label')); ?></label>
        <input wire:model.defer="url" type="text" id="url" class="custom-input" placeholder="<?php echo e(trans('webtools/tools/url-encoder.placeholder')); ?>">
    </div>
    ...
    <?php elseif($this->status === 'failure'): ?>
        <div class="form-group">
            <div class="border-0 alert alert-danger rounded-pill bg-danger">
                <h5 class="m-0 d-inline-block text-light p-l-25 flex-grow-1 me-3"><?php echo e(trans('webtools/tools/url-encoder.error')); ?></h5>
            </div>
        </div>
    <?php endif; ?>
    ...
    <button class="btn custom--btn button__lg" wire:loading.class="disabled" wire:loading.attr="disabled">
        <span wire:loading.class="d-none">
            <?php echo e(trans('webtools/tools/url-encoder.submit')); ?>
...
</form><?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/modules/tools/url-encoder/livewire.blade.php ENDPATH**/ ?>