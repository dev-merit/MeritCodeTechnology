...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="btn custom--btn button__lg copy-btn btn__dark mt-2 ">
            ...
            <div class="mt-4">
                <a class="text-primary" href="<?php echo e(route('password.reset')); ?>">Reset your Password</a>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>