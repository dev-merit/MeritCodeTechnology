<form wire:submit.prevent="submit">
    ...
    <?php if($this->error === 'failure'): ?>
        <div class="form-group">
            <div class="border-0 alert alert-danger rounded-pill bg-danger">
                <h5 class="m-0 d-inline-block text-light p-l-25 flex-grow-1 me-3 text-break"><?php echo e(trans('webtools/tools/privacy-policy-generator.error')); ?></h5>
            </div>
        </div>
    <?php endif; ?>
    ...
    <?php endif; ?>
</form><?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/modules/tools/privacy-policy-generator/livewire.blade.php ENDPATH**/ ?>