<div class="col-span-2 filament-widget">
    <?php if(!function_exists('symlink')): ?>
    ...
    <?php endif; ?>
</div><?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/filament/widgets/symlink-warning.blade.php ENDPATH**/ ?>