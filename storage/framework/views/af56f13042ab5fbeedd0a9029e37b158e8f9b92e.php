...
} elseif ($_instance->childHasBeenRendered('7nTiKW1')) {
    $componentId = $_instance->getRenderedChildComponentId('7nTiKW1');
    $componentTag = $_instance->getRenderedChildComponentTagName('7nTiKW1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7nTiKW1');
} else {
    $response = \Livewire\Livewire::mount($wireComponent);
    $html = $response->html();
    $_instance->logRenderedChild('7nTiKW1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php else: ?>
...
<div class="content-sec">
    <div class="content-sec-inner">
        <div class="content-title-sec">
            ...
            <div class="main-subtitle"><?php echo e(trans('webtools/general.related')); ?></div>
        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/modules/tool-base.blade.php ENDPATH**/ ?>