<section x-data="window.bitflanSEOTagsGeneratorComponent()">
    <div class="form-group">
        <label class="custom-label"><?php echo e(trans('webtools/tools/seo-tags-generator.label')); ?></label>
    </div>
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
    ...
    <button x-on:click="generate()" class="btn custom--btn button__lg"><?php echo e(trans('webtools/tools/seo-tags-generator.submit')); ?></button>
...
</section><?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/modules/tools/seo-tags-generator/view.blade.php ENDPATH**/ ?>