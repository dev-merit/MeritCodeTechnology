    ...
    <div class="row">
        <div class="col-4">
            <div class="form-group">
                ...
                <input x-model="r" value="255" type="number" class="custom-input" placeholder="R">
            </div>
        </div>
        <div class="col-4">
            <div class="form-group">
                <label class="custom-label"><?php echo e(trans('webtools/tools/rgb-to-hex.green')); ?></label>
                <input x-model="g" value="255" type="number" class="custom-input" placeholder="G">
            </div>
        </div>
        <div class="col-4">
            <div class="form-group">
                <label class="custom-label"><?php echo e(trans('webtools/tools/rgb-to-hex.blue')); ?></label>
                <input x-model="b" value="255" type="number" class="custom-input" placeholder="B">
            </div>
        </div>
    </div>
...
</div><?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/modules/tools/rgb-to-hex/view.blade.php ENDPATH**/ ?>