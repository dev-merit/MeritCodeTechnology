                    ...
                    <div class="pricing-plan-main">
                        <div class="plans basic">
                            <div class="plans-text-section">
                                ...
                                <div class="package-price"><span class="dollar">$</span><?php echo e(floor($sass->premiumPriceMonthly)); ?><span>.<?php echo e($sass->premiumPriceMonthly * 100 - (floor($sass->premiumPriceMonthly) * 100)); ?></span></div>
                                <div class="package-detail">billed monthly.</div>
                            </div>
                            <a href="<?php echo e(route('monthly.subscription')); ?>" class="plan-btn">Subscribe</a>
                        </div>
                        <div class="plans">
                            <div class="plans-text-section">
                                <div class="package">Yearly</div>
                                <div class="package-subtitle">Get Access to all Features</div>
                                <div class="package-price"><span class="dollar">$</span><?php echo e(floor($sass->premiumPriceAnnually)); ?><span>.<?php echo e($sass->premiumPriceAnnually * 100 - (floor($sass->premiumPriceAnnually) * 100)); ?></span></div>
                                <div class="package-detail">billed yearly.</div>
                            </div>
                            <a href="<?php echo e(route('yearly.subscription')); ?>" class="plan-btn">Subscribe</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="table-responsive">
                    <table class="table plansFeaturesTable">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $sass->premiumTools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $toolKey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td scope="row" class="text-left"><?php echo e(get_tool_title_from_key($toolKey)); ?></td>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/payments/pricing.blade.php ENDPATH**/ ?>