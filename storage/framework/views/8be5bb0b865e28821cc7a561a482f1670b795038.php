                ...
                <?php if(is_array($element)): ?>
                    <?php $__currentLoopData = $element; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($page == $paginator->currentPage()): ?>
                            <li><a href="javascript:void(0)" class="active" aria-current="page"><span><?php echo e($page); ?></span></a></li>
                        <?php else: ?>
...
<?php endif; ?>
<?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/components/pagination-links.blade.php ENDPATH**/ ?>