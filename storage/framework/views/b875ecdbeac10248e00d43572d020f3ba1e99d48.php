<div>
    <div class="mb-5 form-group">
        ...
        <div class="copy-textarea-btn">
            <input type="text" wire:model.defer='keyword' class="custom-input" placeholder="<?php echo e(trans('webtools/tools/domain-generator.placeholder')); ?>" />
        </div>
    ...
    <?php if($this->error == 0 && count($this->domains)): ?>
        <?php $__currentLoopData = $this->domains; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $domain): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="d-flex justify-content-between align-items-center bg-light py-2 px-3 rounded mb-1">
                ...
                <a class="btn custom--btn px-2 py-1" target="_blank" href="<?php echo e(strtolower($domain['link'])); ?>"><?php echo e(trans('webtools/tools/domain-generator.buy')); ?></a>
            </div>
    ...
    <?php endif; ?>
</div><?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/modules/tools/domain-generator/livewire.blade.php ENDPATH**/ ?>