        ...
        window.bitflanMarkdownToHtmlComponent = function() {
            return {
                ...
                init() {
                    ...
                    this.output.setOption("showPrintMargin", false);
...
<div x-data="window.bitflanMarkdownToHtmlComponent()">
    <div class="form-group">
        <label class="custom-label"><?php echo e(trans('webtools/tools/markdown-to-html.label')); ?></label>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="form-group">
    ...
    <button x-on:click="convert()" class="btn custom--btn button__lg"><?php echo e(trans('webtools/tools/markdown-to-html.submit')); ?></button>
...
</div><?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/modules/tools/markdown-to-html/view.blade.php ENDPATH**/ ?>