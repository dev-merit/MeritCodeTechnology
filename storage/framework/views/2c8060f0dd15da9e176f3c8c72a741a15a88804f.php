    ...
    <div class="single-page-inner">
        <form>
            <div class="form-group">
                <label for="decodeQuote" class="custom-label"><?php echo e(trans('webtools/tools/quoted-printable-decode.label')); ?></label>
                <textarea type="text" name="decodeQuote" id="decodeQuote" class="custom-textarea" placeholder='<?php echo e(trans('webtools/tools/quoted-printable-decode.placeholder')); ?>' rows="5" required><?php echo e(request()->input('decodeQuote')); ?></textarea>
                <input type="hidden" name="submit" value="true">
            </div>
            <button class="btn custom--btn button__lg"><?php echo e(trans('webtools/tools/quoted-printable-decode.submit')); ?></button>
            <?php if(request()->input('submit') && request()->input('decodeQuote') == ''): ?>
                <div class="alert alert-danger rounded-pill mt-3 p-l-25 p-r-25 bg-danger border-0"><h5 class="m-0 text-light"><?php echo e(trans('webtools/tools/quoted-printable-decode.fieldEmpty')); ?></h5></div>
            <?php endif; ?>
        </form>

        <?php if($decoded_printable): ?>
            <hr class="">

            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        <label class="custom-label"><?php echo e(trans('webtools/tools/quoted-printable-decode.converted-label')); ?></label>
                        <div class="copy-textarea-btn">
                            <textarea type="email" id="decoded-copy" class="custom-textarea" rows="9"><?php echo e($quoted-printable-decode); ?></textarea>
                            <button onclick="window.writeClipboardTextVanilla(this, document.getElementById('decoded-copy').value)" class="btn custom--btn button__md copy-btn btn__dark"><?php echo e(trans('webtools/tools/quoted-printable-decode.btn-copy')); ?></button>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/modules/tools/quoted-printable-decode/view.blade.php ENDPATH**/ ?>