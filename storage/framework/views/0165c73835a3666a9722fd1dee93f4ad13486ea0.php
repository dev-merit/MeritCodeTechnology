...
<div x-data="window.bitflanRobotstxtComponent()">
    <div class="row">
        <div class="col-md-6 col-12">
            <div class="form-group">
                <label class="custom-label"><?php echo e(trans('webtools/tools/robotstxt-generator.default_for_all')); ?></label>
                <select x-model="usual" class="custom-input form-select">
                    <option selected value="allowed"><?php echo e(trans('webtools/tools/robotstxt-generator.allowed')); ?></option>
                    <option value="refused"><?php echo e(trans('webtools/tools/robotstxt-generator.refused')); ?></option>
                </select>
            </div>
        </div>
        ...
        <div class="col-md-6 col-12">
            <div class="form-group">
                <label class="custom-label"><?php echo e(trans('webtools/tools/robotstxt-generator.crawl_delay')); ?></label>
    ...
    <div class="form-group">
        <label class="custom-label"><?php echo e(trans('webtools/tools/robotstxt-generator.sitemap')); ?></label>
        <input x-model="sitemap" type="text" class="custom-input" placeholder="<?php echo e(trans('webtools/tools/robotstxt-generator.sitemap_holder')); ?>">
    </div>
    ...
    <div class="form-group">
        <label class="custom-label"><?php echo e(trans('webtools/tools/robotstxt-generator.directories')); ?></label>
        <input x-model="dirs" type="text" class="custom-input" placeholder="<?php echo e(trans('webtools/tools/robotstxt-generator.directories_holder')); ?>">
    </div>

    <button x-on:click="generate()" class="btn custom--btn button__lg"><?php echo e(trans('webtools/tools/robotstxt-generator.submit')); ?></button>
...
</div><?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/modules/tools/robotstxt-generator/view.blade.php ENDPATH**/ ?>