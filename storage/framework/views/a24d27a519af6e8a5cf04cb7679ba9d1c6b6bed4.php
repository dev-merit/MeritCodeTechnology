...
<div x-data="window.bitflanConvertComponent()">
    <div class="form-group">
        <label class="custom-label"><?php echo e(trans('webtools/tools/png-to-jpg.image')); ?></label>
        <input type="file" x-ref="upload" class="form-control" accept="image/png" />
    </div>
    <div class="form-group">
        <button @click="generate()" class="btn custom--btn button__lg"><?php echo e(trans('webtools/tools/png-to-jpg.submit')); ?></button>
    </div>
...
<?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/modules/tools/png-to-jpg/view.blade.php ENDPATH**/ ?>