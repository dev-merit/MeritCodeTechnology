...
<?php $component->withAttributes([]); ?>
        <div class="flex items-center h-12 space-x-4 rtl:space-x-reverse">
            <div class="flex items-center justify-center w-10 h-10 font-bold text-white bg-indigo-500 bg-center bg-contain rounded-lg text-md"><?php echo e($this->version); ?></div>

            <div>
                <h2 class="text-lg font-bold tracking-tight sm:text-xl">
                    <?php echo e($this->name); ?>

                </h2>

                <p class="text-sm">
                    <a href="<?php echo e($this->vendor_url); ?>" class="text-gray-600 hover:text-primary-500 focus:outline-none focus:underline"><?php echo e($this->vendor); ?></a>
                </p>
            </div>
        </div>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /home/awsstart/domains/meritcodetechnology.com/public_html/resources/views/filament/widgets/script-information.blade.php ENDPATH**/ ?>